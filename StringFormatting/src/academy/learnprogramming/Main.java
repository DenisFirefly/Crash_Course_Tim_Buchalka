...
//        System.out.printf("%-15s %-4d %6s %n", apples, appleQuantity, currencyFormat.format(applePrice/ 100.0));
//        System.out.printf("%-15s %-4d %6s %n", oranges, orangeQuantity, currencyFormat.format(orangePrice / 100.0));
